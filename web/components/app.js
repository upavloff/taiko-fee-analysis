...
class TaikoFeeExplorer {
    ...
    updateInfoBox() {
        ...
        document.getElementById('info-alpha').textContent = params.alpha_data;
    ...
    updateParameterDisplays() {
        ...
        document.getElementById('alpha-value').textContent = document.getElementById('alpha-slider').value;
    ...
    getCurrentParameters() {
        ...
        const params = {
            ...
            alpha_data: parseFloat(document.getElementById('alpha-slider').value),
            ...
            targetBalance: 100,
            vaultTargetBalance: 1000.0, // ETH - for AlphaSimulationEngine
            feeElasticity: 0.2,
            minFee: 1e-8
        };
    ...
    loadPreset(presetName) {
        ...
        document.getElementById('alpha-slider').value = preset.alpha_data;
    ...
    async runSimulation() {
        ...
        try {
            ...
            // Use AlphaSimulationEngine for alpha-data model
            const simulator = new AlphaSimulationEngine({
                mu: params.mu,
                alpha_data: params.alpha_data,
                nu: params.nu,
                H: params.H,
                targetBalance: params.vaultTargetBalance,
                vaultInit: params.vaultInit,
                l1Source: params.l1Source,
                historicalPeriod: params.historicalPeriod,
                l1Volatility: params.l1Volatility,
                seed: params.seed,
                txsPerBatch: params.txsPerBatch
            });
        ...
        return `
            <div class="preset-detail-section">
                ...
                <div class="preset-parameters">
                    ...
                    <div class="preset-param">α_data = ${preset.alpha_data}</div>
            ...
            <div class="preset-detail-section">
                ...
                <div class="preset-formula">
                    $$f^{\\mathrm{raw}}(t) = ${preset.mu} \\cdot ${preset.alpha_data} \\cdot L1_{basefee}(t) + ${preset.nu} \\cdot \\frac{D(t)}{${preset.H} \\cdot \\bar{Q}} + \\frac{Proof_{gas} \\cdot L1_{basefee}(t)}{L2_{gas}}$$
                </div>
    ...
    getFormulaExplanation(preset) {
        return `Alpha-data model: fees use direct L1 basefee tracking (α_data=${preset.alpha_data}) plus vault deficit correction (${preset.nu} × D(t)/(${preset.H} × L2_gas)). This replaces the broken Q̄ = 690,000 constant with empirically-measured DA cost ratios. Higher α_data = stronger L1 tracking, higher ν = faster deficit correction.`;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('- AlphaSimulationEngine:', typeof AlphaSimulationEngine !== 'undefined');
    console.log('- AlphaFeeController:', typeof AlphaFeeController !== 'undefined');
    ...
    if (typeof AlphaSimulationEngine === 'undefined') {
        console.error('❌ Alpha Simulation Engine not loaded');
        return;
    }
