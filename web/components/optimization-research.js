...
class OptimizationResearchController {
    ...
    previewSolutionMetrics(solution) {
        ...
        console.log('👀 Previewing solution:', solution.alpha_data, solution.nu, solution.H);
    }
    ...
    exportSolution(solutionDataString) {
        try {
            ...
            a.href = url;
            a.download = `taiko-solution-alpha${solution.alpha_data.toFixed(3)}-nu${solution.nu.toFixed(3)}-H${solution.H}-${Date.now()}.json`;
    ...
    async startOptimization() {
        ...
        try {
            ...
            if (window.NSGAII) {
                ...
                console.log('🎯 Algorithm rates - Crossover:', algorithmParams.crossoverRate, 'Mutation:', algorithmParams.mutationRate);
            }
    ...
    removeDuplicates() {
        ...
        console.log(`🧹 Removed ${removedCount} duplicate solutions`);
        return removedCount;
    }
    ...
    handleNewSolution(solution) {
        ...
        if (wasAdded) {
            ...
            console.log('🔄 Duplicate solution skipped');
        }
    }
    ...
    handleOptimizationComplete(results) {
        ...
        console.log(`🎯 Final unique solutions: ${uniqueCount} (${newSolutionsAdded} newly added)`);
    ...
    addTestDuplicates() {
        if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
            console.log('🧪 Adding test duplicate solutions...');
            ...
            console.log(`🧪 Added ${testSolutions.length} test solutions (includes duplicates)`);
